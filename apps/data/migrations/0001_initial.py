# Generated by Django 4.2.23 on 2025-06-21 20:58
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('ValidCcCombo', models.CharField(default='All', max_length=8, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('BatchStatus', models.CharField(default='Unposted', max_length=12, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('ClearingAccount', models.CharField(default='8500', max_length=12, null=True)),
                ('RetEarningsAccountCode', models.CharField(default='9700', max_length=12, null=True)),
                ('RollupStyle', models.CharField(default='Always', max_length=12, null=True)),
            ],
        ),
        migrations.CreateModel(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('BatchStatus', models.CharField(default='Unposted', max_length=8, null=True)),
                ('BatchPeriod', models.IntegerField(default=0)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('JournalStatus', models.CharField(default='Unposted', max_length=12, null=True)),
                ('ExchangeRateToBase', models.DecimalField(decimal_places=10, default=0, max_digits=24)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('ManualModication', models.BooleanField(default=False)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('AccomodationType', models.CharField(default='OTHER', max_length=8, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('Gender', models.CharField(default='Unknown', max_length=8, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('ArrivalDetailsStatus', models.CharField(default='no', max_length=12, null=True)),
                ...
                ('DepartureDetailsStatus', models.CharField(default='no', max_length=12, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('MembershipStatus', models.CharField(default='ACTIVE', max_length=12, null=True)),
            ],
        ),
        migrations.CreateModel(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('SubscriptionStatus', models.CharField(default='PERMANENT', max_length=12, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('FormOrientation', models.CharField(default='P', max_length=20, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('MonthName1', models.CharField(max_length=20)),
                ('MonthName2', models.CharField(max_length=20)),
                ('MonthName3', models.CharField(max_length=20)),
                ('MonthName4', models.CharField(max_length=20)),
                ('MonthName5', models.CharField(max_length=20)),
                ('MonthName6', models.CharField(max_length=20)),
                ('MonthName7', models.CharField(max_length=20)),
                ('MonthName8', models.CharField(max_length=20)),
                ('MonthName9', models.CharField(max_length=20)),
                ('MonthName10', models.CharField(max_length=20)),
                ('MonthName11', models.CharField(max_length=20)),
                ('MonthName12', models.CharField(max_length=20)),
                ('MonthNameShort1', models.CharField(max_length=3)),
                ('MonthNameShort2', models.CharField(max_length=3)),
                ('MonthNameShort3', models.CharField(max_length=3)),
                ('MonthNameShort4', models.CharField(max_length=3)),
                ('MonthNameShort5', models.CharField(max_length=3)),
                ('MonthNameShort6', models.CharField(max_length=3)),
                ('MonthNameShort7', models.CharField(max_length=3)),
                ('MonthNameShort8', models.CharField(max_length=3)),
                ('MonthNameShort9', models.CharField(max_length=3)),
                ('MonthNameShort10', models.CharField(max_length=3)),
                ('MonthNameShort11', models.CharField(max_length=3)),
                ('MonthNameShort12', models.CharField(max_length=3)),
            ],
        ),
        migrations.CreateModel(
            name='SLogin',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('LanguageCode', models.CharField(default='99', max_length=10, null=True)),
                ('CanModify', models.BooleanField(default=True, null=True)),
        ...
        migrations.AddField(
            ...
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='ATransactionType_CreditAccountCode', to='data.aaccount'),
        ),
        migrations.AddField(
            model_name='atransactiontype',
            name='DebitAccountCode',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='ATransactionType_DebitAccountCode', to='data.aaccount'),
        ),
        migrations.AddField(
            model_name='atransactiontype',
            name='Ledger',
        ...
        migrations.AddField(
            model_name='aepstatement',
            name='BankAccount',
            field=models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, related_name='AEpStatement_BankAccount', to='data.pbankingdetails'),
        ),
        migrations.AddField(
            model_name='aepstatement',
            name='Currency',
        ...
        migrations.AddField(
            ...
            name='CostCentreType',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='ACostCentre_CostCentreType', to='data.acostcentretype'),
        ),
        migrations.AddField(
            model_name='acostcentre',
            name='Ledger',
        ...
        migrations.AddField(
            ...
            name='AccountCodeToReportTo',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='AAccountHierarchyDetail_AccountCodeToReportTo', to='data.aaccount'),
        ),
        migrations.AddField(
            model_name='aaccounthierarchydetail',
        ...
        migrations.AddField(
            model_name='aaccounthierarchydetail',
            name='ReportingAccountCode',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='AAccountHierarchyDetail_ReportingAccountCode', to='data.aaccount'),
        ),
        migrations.AddField(
        ...
        migrations.AddConstraint(
            model_name='aaccounthierarchydetail',
            constraint=models.UniqueConstraint(fields=('AccountHierarchy', 'ReportingAccountCode'), name='a_account_hierarchy_detail_pk'),
        ),
        migrations.AddConstraint(
            model_name='aaccounthierarchy',
