# Generated by Django 5.2.3 on 2025-06-30 19:21
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('Code', models.CharField(max_length=16)),
                ('RootAccount', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='AAccountHierarchy_RootAccount', to='data.aaccount')),
            ],
        ),
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('Active', models.BooleanField(default=True, null=True)),
                ('Account', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='AAnalysisAttribute_Account', to='data.aaccount')),
                ('AnalysisType', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='AAnalysisAttribute_AnalysisType', to='data.aanalysistype')),
                ('CostCentre', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, related_name='AAnalysisAttribute_CostCentre', to='data.acostcentre')),
            ],
        ),
        migrations.CreateModel(
            name='AApDocument',
            fields=[
                ...
                ('ApAccount', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, related_name='AApDocument_ApAccount', to='data.aaccount')),
                ('Partner', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='AApDocument_Partner', to='data.aapsupplier')),
            ],
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('ArArticle', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='AArArticlePrice_ArArticle', to='data.aararticle')),
                ('Currency', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='AArArticlePrice_Currency', to='data.acurrency')),
            ],
        ),
        migrations.AddField(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('ArArticle', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, related_name='AArDiscount_ArArticle', to='data.aararticle')),
                ('Currency', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='AArDiscount_Currency', to='data.acurrency')),
                ('PartnerType', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, related_name='AArDiscount_PartnerType', to='data.ptype')),
            ],
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('ArArticlePrice', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='AArInvoiceDetail_ArArticlePrice', to='data.aararticleprice')),
                ('ArInvoice', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='AArInvoiceDetail_ArInvoice', to='data.aarinvoice')),
                ('Currency', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='AArInvoiceDetail_Currency', to='data.acurrency')),
            ],
        ),
        migrations.AddField(
            model_name='aaccount',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('FromCurrency', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='ADailyExchangeRate_FromCurrency', to='data.acurrency')),
                ('ToCurrency', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='ADailyExchangeRate_ToCurrency', to='data.acurrency')),
            ],
        ),
        migrations.CreateModel(
            name='AEpMatch',
            fields=[
                ...
                ('Restricted', models.BooleanField(default=False, null=True)),
                ('Account', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, related_name='AEpMatch_Account', to='data.aaccount')),
                ('CostCentre', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, related_name='AEpMatch_CostCentre', to='data.acostcentre')),
            ],
        ),
        migrations.CreateModel(
            name='AEpStatement',
            fields=[
                ...
                ('BankAccount', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='AEpStatement_BankAccount', to='data.aaccount')),
                ('Currency', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='AEpStatement_Currency', to='data.acurrency')),
            ],
        ),
        migrations.CreateModel(
            name='AEpTransaction',
            fields=[
                ...
                ('DateEffective', models.DateTimeField()),
                ('EpMatch', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, related_name='AEpTransaction_EpMatch', to='data.aepmatch')),
                ('Statement', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='AEpTransaction_Statement', to='data.aepstatement')),
            ],
        ),
        migrations.CreateModel(
            name='AForm',
            ...
            options={
                'constraints': [models.UniqueConstraint(fields=('Code', 'Name'), name='a_form_pk')],
            },
        ),
        migrations.CreateModel(
            ...
            options={
                'constraints': [models.UniqueConstraint(fields=('FormCode', 'Code'), name='a_form_element_type_pk')],
            },
        ),
        migrations.CreateModel(
            name='AFormElement',
            fields=[
                ...
                ('Form', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='AFormElement_Form', to='data.aform')),
                ('FormElementType', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='AFormElement_FormElementType', to='data.aformelementtype')),
            ],
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('Account', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='AGeneralLedgerMaster_Account', to='data.aaccount')),
                ('CostCentre', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='AGeneralLedgerMaster_CostCentre', to='data.acostcentre')),
            ],
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('GlmSequence', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='AGeneralLedgerMasterPeriod_GlmSequence', to='data.ageneralledgermaster')),
            ],
        ),
        migrations.CreateModel(
            name='ALedger',
            fields=[
                ...
                ('BaseCurrency', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, related_name='ALedger_BaseCurrency', to='data.acurrency')),
                ('IntlCurrency', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, related_name='ALedger_IntlCurrency', to='data.acurrency')),
                ('TaxType', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, related_name='ALedger_TaxType', to='data.ataxtype')),
                ('Country', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, related_name='ALedger_Country', to='data.pcountry')),
            ],
        ),
        migrations.CreateModel(
            name='AJournal',
            fields=[
                ...
                ('BaseCurrency', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, related_name='AJournal_BaseCurrency', to='data.acurrency')),
                ('Batch', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='AJournal_Batch', to='data.abatch')),
                ('TransactionCurrency', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='AJournal_TransactionCurrency', to='data.acurrency')),
                ('Ledger', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='AJournal_Ledger', to='data.aledger')),
            ],
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('AccountingPeriod', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='AIchStewardship_AccountingPeriod', to='data.aaccountingperiod')),
                ('CostCentre', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='AIchStewardship_CostCentre', to='data.acostcentre')),
                ('Ledger', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='AIchStewardship_Ledger', to='data.aledger')),
            ],
        ),
        migrations.CreateModel(
            name='AGiftBatch',
            fields=[
                ...
                ('BankAccount', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='AGiftBatch_BankAccount', to='data.aaccount')),
                ('BankCostCentre', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='AGiftBatch_BankCostCentre', to='data.acostcentre')),
                ('Currency', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='AGiftBatch_Currency', to='data.acurrency')),
                ('Ledger', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='AGiftBatch_Ledger', to='data.aledger')),
            ],
        ),
        migrations.AddField(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('Active', models.BooleanField(default=True, null=True)),
                ('AnalysisType', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='AFreeformAnalysis_AnalysisType', to='data.aanalysistype')),
                ('Ledger', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='AFreeformAnalysis_Ledger', to='data.aledger')),
            ],
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('Account', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='AFeesReceivable_Account', to='data.aaccount')),
                ('CostCentre', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='AFeesReceivable_CostCentre', to='data.acostcentre')),
                ('DrAccount', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='AFeesReceivable_DrAccount', to='data.aaccount')),
                ('Ledger', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='AFeesReceivable_Ledger', to='data.aledger')),
            ],
        ),
        migrations.CreateModel(
            name='AFeesPayable',
            fields=[
                ...
                ('ChargeAmount', models.DecimalField(decimal_places=10, default=0, max_digits=24, null=True)),
                ('FeeDescription', models.CharField(max_length=48, null=True)),
                ('Account', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='AFeesPayable_Account', to='data.aaccount')),
                ('CostCentre', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='AFeesPayable_CostCentre', to='data.acostcentre')),
                ('DrAccount', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='AFeesPayable_DrAccount', to='data.aaccount')),
                ('Ledger', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='AFeesPayable_Ledger', to='data.aledger')),
            ],
        ),
        migrations.AddField(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('Reference', models.CharField(max_length=100, null=True)),
                ('Account', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='AEpPayment_Account', to='data.aaccount')),
                ('Ledger', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='AEpPayment_Ledger', to='data.aledger')),
                ('User', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, related_name='AEpPayment_User', to='data.suser')),
            ],
        ),
        migrations.AddField(
            model_name='aepmatch',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('Amount', models.DecimalField(decimal_places=10, max_digits=24, null=True)),
                ('ApDocument', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, related_name='AEpDocumentPayment_ApDocument', to='data.aapdocument')),
                ('EpPayment', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='AEpDocumentPayment_EpPayment', to='data.aeppayment')),
                ('Ledger', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='AEpDocumentPayment_Ledger', to='data.aledger')),
            ],
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('CreditNoteDocument', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='ACrdtNoteInvoiceLink_CreditNoteDocument', to='data.aapdocument')),
                ('InvoiceDocument', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='ACrdtNoteInvoiceLink_InvoiceDocument', to='data.aapdocument')),
                ('Ledger', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='ACrdtNoteInvoiceLink_Ledger', to='data.aledger')),
            ],
        ),
        migrations.AddField(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('Description', models.CharField(max_length=200, null=True)),
                ('Ledger', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='ABudgetRevision_Ledger', to='data.aledger')),
            ],
        ),
        migrations.CreateModel(
            name='ABudget',
            fields=[
                ...
                ('Account', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='ABudget_Account', to='data.aaccount')),
                ('BudgetRevision', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='ABudget_BudgetRevision', to='data.abudgetrevision')),
                ('BudgetType', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='ABudget_BudgetType', to='data.abudgettype')),
                ('CostCentre', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='ABudget_CostCentre', to='data.acostcentre')),
                ('Ledger', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='ABudget_Ledger', to='data.aledger')),
            ],
        ),
        migrations.AddField(
            model_name='abatch',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('ArDiscount', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='AArInvoiceDiscount_ArDiscount', to='data.aardiscount')),
                ('ArInvoice', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='AArInvoiceDiscount_ArInvoice', to='data.aarinvoice')),
                ('Ledger', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='AArInvoiceDiscount_Ledger', to='data.aledger')),
            ],
        ),
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('ArDiscount', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='AArInvoiceDetailDiscount_ArDiscount', to='data.aardiscount')),
                ('ArInvoiceDetail', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='AArInvoiceDetailDiscount_ArInvoiceDetail', to='data.aarinvoicedetail')),
                ('Ledger', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='AArInvoiceDetailDiscount_Ledger', to='data.aledger')),
            ],
        ),
        migrations.AddField(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('Reference', models.CharField(max_length=100, null=True)),
                ('Account', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='AApPayment_Account', to='data.aaccount')),
                ('Ledger', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='AApPayment_Ledger', to='data.aledger')),
                ('User', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, related_name='AApPayment_User', to='data.suser')),
            ],
        ),
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('Amount', models.DecimalField(decimal_places=10, max_digits=24, null=True)),
                ('ApDocument', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='AApDocumentPayment_ApDocument', to='data.aapdocument')),
                ('ApPayment', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='AApDocumentPayment_ApPayment', to='data.aappayment')),
                ('Ledger', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='AApDocumentPayment_Ledger', to='data.aledger')),
            ],
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('Account', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, related_name='AApDocumentDetail_Account', to='data.aaccount')),
                ('ApDocument', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='AApDocumentDetail_ApDocument', to='data.aapdocument')),
                ('CostCentre', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, related_name='AApDocumentDetail_CostCentre', to='data.acostcentre')),
                ('Ledger', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='AApDocumentDetail_Ledger', to='data.aledger')),
            ],
        ),
        migrations.AddField(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('Account', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='AApAnalAttrib_Account', to='data.aaccount')),
                ('AnalysisAttribute', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='AApAnalAttrib_AnalysisAttribute', to='data.aanalysisattribute')),
                ('ApDocumentDetail', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='AApAnalAttrib_ApDocumentDetail', to='data.aapdocumentdetail')),
                ('FreeformAnalysis', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='AApAnalAttrib_FreeformAnalysis', to='data.afreeformanalysis')),
                ('Ledger', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='AApAnalAttrib_Ledger', to='data.aledger')),
            ],
        ),
        migrations.AddField(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('Account', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='AAccountProperty_Account', to='data.aaccount')),
                ('Property', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='AAccountProperty_Property', to='data.aaccountpropertycode')),
                ('Ledger', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='AAccountProperty_Ledger', to='data.aledger')),
            ],
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('Ledger', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, related_name='AAccountingSystemParameter_Ledger', to='data.aledger')),
            ],
        ),
        migrations.AddField(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('AccountHierarchy', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='AAccountHierarchyDetail_AccountHierarchy', to='data.aaccounthierarchy')),
                ('AccountToReportTo', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='AAccountHierarchyDetail_AccountToReportTo', to='data.aaccount')),
                ('ReportingAccount', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='AAccountHierarchyDetail_ReportingAccount', to='data.aaccount')),
                ('Ledger', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='AAccountHierarchyDetail_Ledger', to='data.aledger')),
            ],
        ),
        migrations.AddField(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('Ledger', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='ALedgerInitFlag_Ledger', to='data.aledger')),
            ],
        ),
        migrations.AddField(
            model_name='aepmatch',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('GiftBatch', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='AGift_GiftBatch', to='data.agiftbatch')),
                ('Ledger', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='AGift_Ledger', to='data.aledger')),
                ('MethodOfGiving', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, related_name='AGift_MethodOfGiving', to='data.amethodofgiving')),
                ('MethodOfPayment', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, related_name='AGift_MethodOfPayment', to='data.amethodofpayment')),
            ],
        ),
        migrations.AddField(
            model_name='aepmatch',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('Account', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='AMotivationDetail_Account', to='data.aaccount')),
                ('CostCentre', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='AMotivationDetail_CostCentre', to='data.acostcentre')),
                ('Ledger', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='AMotivationDetail_Ledger', to='data.aledger')),
                ('TaxDeductibleAccount', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, related_name='AMotivationDetail_TaxDeductibleAccount', to='data.aaccount')),
            ],
        ),
        migrations.CreateModel(
            name='AGiftDetail',
            fields=[
                ...
                ('Account', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, related_name='AGiftDetail_Account', to='data.aaccount')),
                ('CostCentre', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, related_name='AGiftDetail_CostCentre', to='data.acostcentre')),
                ('Gift', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='AGiftDetail_Gift', to='data.agift')),
                ('GiftBatch', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='AGiftDetail_GiftBatch', to='data.agiftbatch')),
                ('TaxDeductibleAccount', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, related_name='AGiftDetail_TaxDeductibleAccount', to='data.aaccount')),
                ('Ledger', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='AGiftDetail_Ledger', to='data.aledger')),
                ('MotivationDetail', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='AGiftDetail_MotivationDetail', to='data.amotivationdetail')),
                ('Mailing', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, related_name='AGiftDetail_Mailing', to='data.pmailing')),
            ],
        ),
        migrations.AddField(
            model_name='aepmatch',
            name='MotivationDetail',
            field=models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, related_name='AEpMatch_MotivationDetail', to='data.amotivationdetail'),
        ),
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('FeeCode', models.CharField(max_length=16)),
                ('Ledger', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='AMotivationDetailFee_Ledger', to='data.aledger')),
                ('MotivationDetail', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='AMotivationDetailFee_MotivationDetail', to='data.amotivationdetail')),
            ],
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('Restricted', models.BooleanField(default=False, null=True)),
                ('Ledger', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='AMotivationGroup_Ledger', to='data.aledger')),
            ],
        ),
        migrations.AddField(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('AccountingPeriod', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='AProcessedFee_AccountingPeriod', to='data.aaccountingperiod')),
                ('CostCentre', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='AProcessedFee_CostCentre', to='data.acostcentre')),
                ('GiftBatch', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='AProcessedFee_GiftBatch', to='data.agiftbatch')),
                ('GiftDetail', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='AProcessedFee_GiftDetail', to='data.agiftdetail')),
                ('Ledger', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='AProcessedFee_Ledger', to='data.aledger')),
            ],
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('LastJournal', models.IntegerField(default=0)),
                ('Frequency', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, related_name='ARecurringBatch_Frequency', to='data.afrequency')),
                ('Ledger', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='ARecurringBatch_Ledger', to='data.aledger')),
                ('User', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, related_name='ARecurringBatch_User', to='data.suser')),
            ],
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('GiftType', models.CharField(default='Gift', max_length=16)),
                ('MethodOfPaymentCode', models.CharField(max_length=16, null=True)),
                ('BankAccount', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='ARecurringGiftBatch_BankAccount', to='data.aaccount')),
                ('BankCostCentre', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, related_name='ARecurringGiftBatch_BankCostCentre', to='data.acostcentre')),
                ('Currency', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='ARecurringGiftBatch_Currency', to='data.acurrency')),
                ('Ledger', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='ARecurringGiftBatch_Ledger', to='data.aledger')),
            ],
        ),
        migrations.CreateModel(
            name='ARecurringGift',
            fields=[
                ...
                ('Active', models.BooleanField(default=True)),
                ('Ledger', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='ARecurringGift_Ledger', to='data.aledger')),
                ('MethodOfGiving', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, related_name='ARecurringGift_MethodOfGiving', to='data.amethodofgiving')),
                ('MethodOfPayment', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, related_name='ARecurringGift_MethodOfPayment', to='data.amethodofpayment')),
                ('RecurringGiftBatch', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='ARecurringGift_RecurringGiftBatch', to='data.arecurringgiftbatch')),
            ],
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('LastTransactionNumber', models.IntegerField(default=0)),
                ('ExchangeRateToBase', models.DecimalField(decimal_places=10, default=0, max_digits=24)),
                ('Ledger', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='ARecurringJournal_Ledger', to='data.aledger')),
                ('MethodOfPayment', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, related_name='ARecurringJournal_MethodOfPayment', to='data.amethodofpayment')),
                ('RecurringBatch', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='ARecurringJournal_RecurringBatch', to='data.arecurringbatch')),
                ('TransactionCurrency', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='ARecurringJournal_TransactionCurrency', to='data.acurrency')),
            ],
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('Account', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='ARecurringTransaction_Account', to='data.aaccount')),
                ('BaseCurrency', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, related_name='ARecurringTransaction_BaseCurrency', to='data.acurrency')),
                ('CostCentre', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='ARecurringTransaction_CostCentre', to='data.acostcentre')),
                ('Ledger', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='ARecurringTransaction_Ledger', to='data.aledger')),
                ('MethodOfPayment', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, related_name='ARecurringTransaction_MethodOfPayment', to='data.amethodofpayment')),
                ('RecurringBatch', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='ARecurringTransaction_RecurringBatch', to='data.arecurringbatch')),
                ('RecurringJournal', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='ARecurringTransaction_RecurringJournal', to='data.arecurringjournal')),
                ('TransactionCurrency', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, related_name='ARecurringTransaction_TransactionCurrency', to='data.acurrency')),
                ('User', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, related_name='ARecurringTransaction_User', to='data.suser')),
            ],
        ),
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('Account', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='ARecurringTransAnalAttrib_Account', to='data.aaccount')),
                ('AnalysisAttribute', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='ARecurringTransAnalAttrib_AnalysisAttribute', to='data.aanalysisattribute')),
                ('CostCentre', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, related_name='ARecurringTransAnalAttrib_CostCentre', to='data.acostcentre')),
                ('FreeformAnalysis', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='ARecurringTransAnalAttrib_FreeformAnalysis', to='data.afreeformanalysis')),
                ('Ledger', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='ARecurringTransAnalAttrib_Ledger', to='data.aledger')),
                ('RecurringBatch', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='ARecurringTransAnalAttrib_RecurringBatch', to='data.arecurringbatch')),
                ('RecurringJournal', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='ARecurringTransAnalAttrib_RecurringJournal', to='data.arecurringjournal')),
                ('RecurringTransaction', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='ARecurringTransAnalAttrib_RecurringTransaction', to='data.arecurringtransaction')),
            ],
        ),
        migrations.CreateModel(
            name='ARevaluation',
            fields=[
                ...
                ('ExchangeRateToBase', models.DecimalField(decimal_places=10, default=0, max_digits=24)),
                ('Batch', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='ARevaluation_Batch', to='data.abatch')),
                ('Ledger', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='ARevaluation_Ledger', to='data.aledger')),
            ],
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('SubSystem', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='ASpecialTransType_SubSystem', to='data.asubsystem')),
            ],
        ),
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('Account', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, related_name='ASuspenseAccount_Account', to='data.aaccount')),
                ('Ledger', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='ASuspenseAccount_Ledger', to='data.aledger')),
            ],
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('Ledger', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='ASystemInterface_Ledger', to='data.aledger')),
                ('SubSystem', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='ASystemInterface_SubSystem', to='data.asubsystem')),
            ],
        ),
        migrations.CreateModel(
            name='ATaxTable',
            fields=[
                ...
                ('Active', models.BooleanField(default=True, null=True)),
                ('Ledger', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='ATaxTable_Ledger', to='data.aledger')),
                ('TaxType', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='ATaxTable_TaxType', to='data.ataxtype')),
            ],
        ),
        migrations.AddField(
            model_name='aarinvoicedetail',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('IchNumber', models.IntegerField(default=0)),
                ('Account', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='ATransaction_Account', to='data.aaccount')),
                ('Batch', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='ATransaction_Batch', to='data.abatch')),
                ('CostCentre', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='ATransaction_CostCentre', to='data.acostcentre')),
                ('Journal', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='ATransaction_Journal', to='data.ajournal')),
                ('Ledger', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='ATransaction_Ledger', to='data.aledger')),
            ],
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('CreditAccount', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='ATransactionType_CreditAccount', to='data.aaccount')),
                ('DebitAccount', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='ATransactionType_DebitAccount', to='data.aaccount')),
                ('Ledger', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='ATransactionType_Ledger', to='data.aledger')),
                ('SubSystem', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='ATransactionType_SubSystem', to='data.asubsystem')),
            ],
        ),
        migrations.AddField(
        ...
        migrations.AddField(
            model_name='ajournal',
            name='TransactionType',
            field=models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, related_name='AJournal_TransactionType', to='data.atransactiontype'),
        ),
        migrations.CreateModel(
            name='ATransAnalAttrib',
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('Account', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='ATransAnalAttrib_Account', to='data.aaccount')),
                ('AnalysisAttribute', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='ATransAnalAttrib_AnalysisAttribute', to='data.aanalysisattribute')),
                ('Batch', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='ATransAnalAttrib_Batch', to='data.abatch')),
                ('CostCentre', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, related_name='ATransAnalAttrib_CostCentre', to='data.acostcentre')),
                ('FreeformAnalysis', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='ATransAnalAttrib_FreeformAnalysis', to='data.afreeformanalysis')),
                ('Journal', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='ATransAnalAttrib_Journal', to='data.ajournal')),
                ('Ledger', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='ATransAnalAttrib_Ledger', to='data.aledger')),
                ('Transaction', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='ATransAnalAttrib_Transaction', to='data.atransaction')),
            ],
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('Extract', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='MExtractParameter_Extract', to='data.mextractmaster')),
            ],
        ),
        migrations.AddField(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('AddressElement', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='PAddressLine_AddressElement', to='data.paddresselement')),
            ],
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('Bank', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='PBankingDetails_Bank', to='data.pbank')),
                ('BankingType', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='PBankingDetails_BankingType', to='data.pbankingtype')),
            ],
        ),
        migrations.AddField(
            model_name='aepstatement',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('TaxDeductible', models.BooleanField(default=True, null=True)),
                ('Account', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='AEpAccount_Account', to='data.aaccount')),
                ('Ledger', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='AEpAccount_Ledger', to='data.aledger')),
                ('MotivationDetail', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, related_name='AEpAccount_MotivationDetail', to='data.amotivationdetail')),
                ('BankingDetails', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, related_name='AEpAccount_BankingDetails', to='data.pbankingdetails')),
            ],
        ),
        migrations.AddField(
            model_name='aaccount',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('Currency', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='PcConference_Currency', to='data.acurrency')),
            ],
        ),
        migrations.CreateModel(
            name='PcAttendee',
            fields=[
                ...
                ('Conference', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='PcAttendee_Conference', to='data.pcconference')),
            ],
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('Conference', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='PcConferenceCost_Conference', to='data.pcconference')),
            ],
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('Conference', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='PcConferenceOption_Conference', to='data.pcconference')),
                ('OptionType', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='PcConferenceOption_OptionType', to='data.pcconferenceoptiontype')),
            ],
        ),
        migrations.CreateModel(
            name='PcDiscount',
            fields=[
                ...
                ('Conference', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='PcDiscount_Conference', to='data.pcconference')),
                ('CostType', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='PcDiscount_CostType', to='data.pccosttype')),
                ('DiscountCriteria', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='PcDiscount_DiscountCriteria', to='data.pcdiscountcriteria')),
            ],
        ),
        migrations.CreateModel(
            name='PcEarlyLate',
            fields=[
                ...
                ('Conference', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='PcEarlyLate_Conference', to='data.pcconference')),
            ],
        ),
        migrations.CreateModel(
            name='PcGroup',
            fields=[
                ...
                ('Name', models.CharField(max_length=80)),
                ('Attendee', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='PcGroup_Attendee', to='data.pcattendee')),
            ],
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('Channel', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='PConsentHistory_Channel', to='data.pconsentchannel')),
            ],
        ),
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('ConsentHistoryEntry', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='PConsentHistoryPermission_ConsentHistoryEntry', to='data.pconsenthistory')),
                ('Purpose', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='PConsentHistoryPermission_Purpose', to='data.pconsentpurpose')),
            ],
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('ContactAttribute', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='PContactAttributeDetail_ContactAttribute', to='data.pcontactattribute')),
            ],
        ),
        migrations.CreateModel(
            name='PAddressLayout',
            fields=[
                ...
                ('AddressLayout', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='PAddressLayout_AddressLayout', to='data.paddresslayoutcode')),
                ('Country', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='PAddressLayout_Country', to='data.pcountry')),
            ],
        ),
        migrations.CreateModel(
            name='PAddressBlock',
            fields=[
                ...
                ('AddressLayout', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='PAddressBlock_AddressLayout', to='data.paddresslayoutcode')),
                ('Country', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='PAddressBlock_Country', to='data.pcountry')),
            ],
        ),
        migrations.AddField(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('Building', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='PcRoom_Building', to='data.pcbuilding')),
            ],
        ),
        migrations.CreateModel(
            name='PcRoomAlloc',
            fields=[
                ...
                ('Attendee', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, related_name='PcRoomAlloc_Attendee', to='data.pcattendee')),
                ('Room', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='PcRoomAlloc_Room', to='data.pcroom')),
            ],
        ),
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('Room', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='PcRoomAttribute_Room', to='data.pcroom')),
                ('RoomAttrType', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='PcRoomAttribute_RoomAttrType', to='data.pcroomattributetype')),
            ],
        ),
        migrations.CreateModel(
            name='PcSupplement',
            fields=[
                ...
                ('Conference', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='PcSupplement_Conference', to='data.pcconference')),
            ],
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('Active', models.BooleanField(default=True, null=True)),
                ('Category', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='PDataLabelLookup_Category', to='data.pdatalabellookupcategory')),
            ],
        ),
        migrations.CreateModel(
            name='PDataLabel',
            fields=[
                ...
                ('Restricted', models.BooleanField(default=False, null=True)),
                ('Currency', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, related_name='PDataLabel_Currency', to='data.acurrency')),
                ('LookupCategory', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, related_name='PDataLabel_LookupCategory', to='data.pdatalabellookupcategory')),
            ],
        ),
        migrations.CreateModel(
            name='PDataLabelUse',
            fields=[
                ...
                ('DataLabel', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='PDataLabelUse_DataLabel', to='data.pdatalabel')),
            ],
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('FoundationPartner', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='PFoundationDeadline_FoundationPartner', to='data.pfoundation')),
            ],
        ),
        migrations.CreateModel(
            name='PhBooking',
            fields=[
                ...
                ('ArInvoice', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, related_name='PhBooking_ArInvoice', to='data.aarinvoice')),
            ],
        ),
        migrations.CreateModel(
            name='PhRoomBooking',
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('Booking', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='PhRoomBooking_Booking', to='data.phbooking')),
                ('RoomAlloc', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='PhRoomBooking_RoomAlloc', to='data.pcroomalloc')),
            ],
        ),
        migrations.CreateModel(
            name='PInterest',
            fields=[
                ...
                ('Description', models.CharField(max_length=100, null=True)),
                ('Category', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, related_name='PInterest_Category', to='data.pinterestcategory')),
            ],
        ),
        migrations.AddField(
            model_name='pcountry',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('AddresseeType', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='PFormality_AddresseeType', to='data.paddresseetype')),
                ('Country', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='PFormality_Country', to='data.pcountry')),
                ('Language', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='PFormality_Language', to='data.planguage')),
            ],
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('Language', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='PAddresseeTitleOverride_Language', to='data.planguage')),
            ],
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('Currency', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='ACurrencyLanguage_Currency', to='data.acurrency')),
                ('Language', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='ACurrencyLanguage_Language', to='data.planguage')),
            ],
        ),
        migrations.CreateModel(
            name='PLocation',
            fields=[
                ...
                ('Restricted', models.BooleanField(default=False, null=True)),
                ('Country', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, related_name='PLocation_Country', to='data.pcountry')),
            ],
        ),
        migrations.AddField(
            model_name='aepmatch',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('UnassignableDate', models.DateTimeField(null=True)),
                ('Deletable', models.BooleanField(default=True, null=True)),
                ('DocCategory', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='PmDocumentType_DocCategory', to='data.pmdocumentcategory')),
            ],
        ),
        migrations.CreateModel(
            name='PmDocument',
            fields=[
                ...
                ('Doc', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='PmDocument_Doc', to='data.pmdocumenttype')),
            ],
        ),
        migrations.CreateModel(
            name='PMembership',
            fields=[
                ...
                ('Frequency', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='PMembership_Frequency', to='data.afrequency')),
            ],
        ),
        migrations.CreateModel(
            name='PMergeField',
            fields=[
                ...
                ('MergeForm', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='PMergeField_MergeForm', to='data.pmergeform')),
            ],
        ),
        migrations.CreateModel(
            name='PContactLog',
            fields=[
                ...
                ('Mailing', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, related_name='PContactLog_Mailing', to='data.pmailing')),
                ('Contact', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='PContactLog_Contact', to='data.pmethodofcontact')),
                ('Module', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, related_name='PContactLog_Module', to='data.smodule')),
                ('User', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, related_name='PContactLog_User', to='data.suser')),
            ],
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('GenAppCurrency', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, related_name='PmGeneralApplication_GenAppCurrency', to='data.acurrency')),
            ],
        ),
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('FileInfo', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, related_name='PmApplicationFile_FileInfo', to='data.pfileinfo')),
                ('GeneralApplication', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='PmApplicationFile_GeneralApplication', to='data.pmgeneralapplication')),
            ],
        ),
        migrations.CreateModel(
            name='POrganisation',
            fields=[
                ...
                ('Business', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, related_name='POrganisation_Business', to='data.pbusiness')),
            ],
        ),
        migrations.AddField(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('Acquisition', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, related_name='PPartner_Acquisition', to='data.pacquisition')),
                ('AddresseeType', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, related_name='PPartner_AddresseeType', to='data.paddresseetype')),
                ('FirstContact', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, related_name='PPartner_FirstContact', to='data.pfirstcontact')),
                ('Language', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, related_name='PPartner_Language', to='data.planguage')),
                ('PartnerClass', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, related_name='PPartner_PartnerClass', to='data.ppartnerclasses')),
                ('Status', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, related_name='PPartner_Status', to='data.ppartnerstatus')),
            ],
        ),
        migrations.AddField(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('Document', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='PmDocumentFile_Document', to='data.pmdocument')),
                ('FileInfo', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, related_name='PmDocumentFile_FileInfo', to='data.pfileinfo')),
                ('Partner', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='PmDocumentFile_Partner', to='data.ppartner')),
            ],
        ),
        migrations.AddField(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('FoundationPartner', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='PFoundationProposal_FoundationPartner', to='data.pfoundation')),
                ('ProposalStatus', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, related_name='PFoundationProposal_ProposalStatus', to='data.pfoundationproposalstatus')),
                ('PartnerSubmittedBy', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, related_name='PFoundationProposal_PartnerSubmittedBy', to='data.ppartner')),
            ],
        ),
        migrations.AddField(
            model_name='pfoundation',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('Partner', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, related_name='PFamily_Partner', to='data.ppartner')),
                ('MaritalStatus', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, related_name='PFamily_MaritalStatus', to='data.ptmaritalstatus')),
            ],
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('DataLabel', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='PDataLabelValuePartner_DataLabel', to='data.pdatalabel')),
                ('Partner', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='PDataLabelValuePartner_Partner', to='data.ppartner')),
                ('ValuePartner', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, related_name='PDataLabelValuePartner_ValuePartner', to='data.ppartner')),
            ],
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('ValueTime', models.IntegerField(default=0, null=True)),
                ('ValueLookup', models.CharField(max_length=80, null=True)),
                ('DataLabel', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='PDataLabelValueApplication_DataLabel', to='data.pdatalabel')),
                ('GeneralApplication', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='PDataLabelValueApplication_GeneralApplication', to='data.pmgeneralapplication')),
                ('ValuePartner', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, related_name='PDataLabelValueApplication_ValuePartner', to='data.ppartner')),
            ],
        ),
        migrations.AddField(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('Denomination', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, related_name='PChurch_Denomination', to='data.pdenomination')),
                ('ContactPartner', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, related_name='PChurch_ContactPartner', to='data.ppartner')),
                ('Partner', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, related_name='PChurch_Partner', to='data.ppartner')),
            ],
        ),
        migrations.AddField(
            model_name='pbank',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('Extract', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='MExtract_Extract', to='data.mextractmaster')),
                ('Location', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='MExtract_Location', to='data.plocation')),
                ('Partner', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='MExtract_Partner', to='data.ppartner')),
            ],
        ),
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('CostCentre', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='AValidLedgerNumber_CostCentre', to='data.acostcentre')),
                ('Ledger', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='AValidLedgerNumber_Ledger', to='data.aledger')),
                ('IltProcessingCentre', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, related_name='AValidLedgerNumber_IltProcessingCentre', to='data.ppartner')),
                ('Partner', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='AValidLedgerNumber_Partner', to='data.ppartner')),
            ],
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('Ledger', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='ARecurringGiftDetail_Ledger', to='data.aledger')),
                ('MotivationDetail', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='ARecurringGiftDetail_MotivationDetail', to='data.amotivationdetail')),
                ('RecurringGift', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='ARecurringGiftDetail_RecurringGift', to='data.arecurringgift')),
                ('RecurringGiftBatch', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='ARecurringGiftDetail_RecurringGiftBatch', to='data.arecurringgiftbatch')),
                ('Mailing', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, related_name='ARecurringGiftDetail_Mailing', to='data.pmailing')),
                ('Recipient', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='ARecurringGiftDetail_Recipient', to='data.ppartner')),
                ('RecipientLedgerNumber', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, related_name='ARecurringGiftDetail_RecipientLedgerNumber', to='data.ppartner')),
            ],
        ),
        migrations.AddField(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('Partner', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='AEmailDestination_Partner', to='data.ppartner')),
            ],
        ),
        migrations.AddField(
            model_name='aarinvoice',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('UnassignableDate', models.DateTimeField(null=True)),
                ('Deletable', models.BooleanField(default=False)),
                ('Category', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='PPartnerAttributeType_Category', to='data.ppartnerattributecategory')),
            ],
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('Partner', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='PPartnerAttribute_Partner', to='data.ppartner')),
                ('ValueCountry', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, related_name='PPartnerAttribute_ValueCountry', to='data.pcountry')),
                ('AttributeType', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='PPartnerAttribute_AttributeType', to='data.ppartnerattributetype')),
            ],
        ),
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('BankingDetails', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='PPartnerBankingDetails_BankingDetails', to='data.pbankingdetails')),
                ('Partner', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='PPartnerBankingDetails_Partner', to='data.ppartner')),
            ],
        ),
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('Type', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='PBankingDetailsUsage_Type', to='data.pbankingdetailsusagetype')),
                ('PartnerBankingDetails', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='PBankingDetailsUsage_PartnerBankingDetails', to='data.ppartnerbankingdetails')),
            ],
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('Partner', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='PPartnerComment_Partner', to='data.ppartner')),
            ],
        ),
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('ContactLog', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='PPartnerContact_ContactLog', to='data.pcontactlog')),
                ('Partner', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='PPartnerContact_Partner', to='data.ppartner')),
            ],
        ),
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('Contact', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='PPartnerContactAttribute_Contact', to='data.pcontactlog')),
                ('ContactAttributeDetail', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='PPartnerContactAttribute_ContactAttributeDetail', to='data.pcontactattributedetail')),
            ],
        ),
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('Contact', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='PPartnerContactFile_Contact', to='data.pcontactlog')),
                ('FileInfo', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, related_name='PPartnerContactFile_FileInfo', to='data.pfileinfo')),
                ('Partner', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='PPartnerContactFile_Partner', to='data.ppartner')),
            ],
        ),
        migrations.CreateModel(
            name='PPartnerFile',
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('FileInfo', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, related_name='PPartnerFile_FileInfo', to='data.pfileinfo')),
                ('Partner', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='PPartnerFile_Partner', to='data.ppartner')),
            ],
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('FileInfo', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, related_name='PPartnerGraphic_FileInfo', to='data.pfileinfo')),
                ('Partner', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='PPartnerGraphic_Partner', to='data.ppartner')),
            ],
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('Restricted', models.BooleanField(default=False, null=True)),
                ('Location', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='PPartnerLocation_Location', to='data.plocation')),
                ('LocationType', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, related_name='PPartnerLocation_LocationType', to='data.plocationtype')),
                ('Partner', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='PPartnerLocation_Partner', to='data.ppartner')),
            ],
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('Membership', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='PPartnerMembership_Membership', to='data.pmembership')),
                ('Partner', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='PPartnerMembership_Partner', to='data.ppartner')),
            ],
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('Membership', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='PPartnerMembershipPaid_Membership', to='data.pmembership')),
                ('Partner', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='PPartnerMembershipPaid_Partner', to='data.ppartner')),
            ],
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('Restricted', models.BooleanField(default=False, null=True)),
                ('Contact', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, related_name='PPartnerReminder_Contact', to='data.pcontactlog')),
                ('Partner', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='PPartnerReminder_Partner', to='data.ppartner')),
                ('Category', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, related_name='PPartnerReminder_Category', to='data.premindercategory')),
                ('Module', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, related_name='PPartnerReminder_Module', to='data.smodule')),
                ('User', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, related_name='PPartnerReminder_User', to='data.suser')),
                ('UserRestriction', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, related_name='PPartnerReminder_UserRestriction', to='data.suser')),
            ],
        ),
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('Partner', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='PPartnerSetPartner_Partner', to='data.ppartner')),
                ('PartnerSet', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='PPartnerSetPartner_PartnerSet', to='data.ppartnerset')),
            ],
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('Partner', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='PPartnerShortCode_Partner', to='data.ppartner')),
            ],
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('Partner', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='PPartnerTaxDeductiblePct_Partner', to='data.ppartner')),
            ],
        ),
        migrations.CreateModel(
            name='PPerson',
            fields=[
                ...
                ('MaritalStatusSince', models.DateTimeField(null=True)),
                ('MaritalStatusComment', models.CharField(max_length=512, null=True)),
                ('Family', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, related_name='PPerson_Family', to='data.pfamily')),
                ('Occupation', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, related_name='PPerson_Occupation', to='data.poccupation')),
                ('Partner', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, related_name='PPerson_Partner', to='data.ppartner')),
                ('MaritalStatus', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, related_name='PPerson_MaritalStatus', to='data.ptmaritalstatus')),
            ],
        ),
        migrations.CreateModel(
            name='PmStaffData',
            fields=[
                ...
                ('Status', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, related_name='PmStaffData_Status', to='data.pmcommitmentstatus')),
                ('Partner', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='PmStaffData_Partner', to='data.pperson')),
            ],
        ),
        migrations.CreateModel(
            name='PmSpecialNeed',
            fields=[
                ...
                ('Partner', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, related_name='PmSpecialNeed_Partner', to='data.pperson')),
            ],
        ),
        migrations.CreateModel(
            name='PmPersonFile',
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('FileInfo', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, related_name='PmPersonFile_FileInfo', to='data.pfileinfo')),
                ('Partner', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='PmPersonFile_Partner', to='data.pperson')),
            ],
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('Partner', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='PmPersonEvaluation_Partner', to='data.pperson')),
            ],
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('Status', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='PmPersonCommitmentStatus_Status', to='data.pmcommitmentstatus')),
                ('Partner', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='PmPersonCommitmentStatus_Partner', to='data.pperson')),
            ],
        ),
        migrations.CreateModel(
            name='PmPersonalData',
            fields=[
                ...
                ('Language', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, related_name='PmPersonalData_Language', to='data.planguage')),
                ('Partner', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, related_name='PmPersonalData_Partner', to='data.pperson')),
            ],
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('Comment', models.TextField(max_length=1000, null=True)),
                ('Partner', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='PmPersonAbsence_Partner', to='data.pperson')),
            ],
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('Partner', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='PmPastExperience_Partner', to='data.pperson')),
            ],
        ),
        migrations.AddField(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('Comment', models.TextField(max_length=2000, null=True)),
                ('Country', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, related_name='PmFormalEducation_Country', to='data.pcountry')),
                ('Partner', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='PmFormalEducation_Partner', to='data.pperson')),
            ],
        ),
        migrations.AddField(
            model_name='pmdocument',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('Range', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='PPostcodeRegionRange_Range', to='data.ppostcoderange')),
                ('Region', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='PPostcodeRegionRange_Region', to='data.ppostcoderegion')),
            ],
        ),
        migrations.CreateModel(
            name='PAction',
            fields=[
                ...
                ('Process', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='PAction_Process', to='data.pprocess')),
            ],
        ),
        migrations.AddField(
            model_name='pfoundation',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('Frequency', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='PPublication_Frequency', to='data.afrequency')),
                ('PublicationLanguage', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, related_name='PPublication_PublicationLanguage', to='data.planguage')),
            ],
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('Currency', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='PPublicationCost_Currency', to='data.acurrency')),
                ('Publication', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='PPublicationCost_Publication', to='data.ppublication')),
            ],
        ),
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('Comment', models.TextField(max_length=2000, null=True)),
                ('Partner', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='PPartnerRelationship_Partner', to='data.ppartner')),
                ('RelatedPartner', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='PPartnerRelationship_RelatedPartner', to='data.ppartner')),
                ('Relation', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='PPartnerRelationship_Relation', to='data.prelation')),
            ],
        ),
        migrations.AddField(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('Process', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='PState_Process', to='data.pprocess')),
            ],
        ),
        migrations.CreateModel(
            name='PPartnerState',
            fields=[
                ...
                ('Partner', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='PPartnerState_Partner', to='data.ppartner')),
                ('State', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, related_name='PPartnerState_State', to='data.pstate')),
            ],
        ),
        migrations.CreateModel(
            name='PSubscription',
            fields=[
                ...
                ('GiftFrom', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, related_name='PSubscription_GiftFrom', to='data.ppartner')),
                ('Partner', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='PSubscription_Partner', to='data.ppartner')),
                ('Publication', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='PSubscription_Publication', to='data.ppublication')),
                ('ReasonSubsCancelled', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, related_name='PSubscription_ReasonSubsCancelled', to='data.preasonsubscriptioncancelled')),
                ('ReasonSubsGiven', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='PSubscription_ReasonSubsGiven', to='data.preasonsubscriptiongiven')),
            ],
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('Comment', models.CharField(max_length=512, null=True)),
                ('Partner', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='PmPersonAbility_Partner', to='data.pperson')),
                ('AbilityArea', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='PmPersonAbility_AbilityArea', to='data.ptabilityarea')),
                ('AbilityLevel', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='PmPersonAbility_AbilityLevel', to='data.ptabilitylevel')),
            ],
        ),
        migrations.AddField(
            model_name='pmgeneralapplication',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('GeneralApplication', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='PmApplicationStatusHistory_GeneralApplication', to='data.pmgeneralapplication')),
                ('Status', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, related_name='PmApplicationStatusHistory_Status', to='data.ptapplicantstatus')),
            ],
        ),
        migrations.AddField(
            model_name='pmgeneralapplication',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('Comment', models.CharField(max_length=512, null=True)),
                ('Partner', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='PTax_Partner', to='data.ppartner')),
            ],
        ),
        migrations.AddField(
            model_name='pmgeneralapplication',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('DefaultAddresseeType', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, related_name='PTitle_DefaultAddresseeType', to='data.paddresseetype')),
            ],
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('YearsOfExperienceAsOf', models.DateTimeField(null=True)),
                ('Comment', models.CharField(max_length=512, null=True)),
                ('Language', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='PmPersonLanguage_Language', to='data.planguage')),
                ('Partner', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='PmPersonLanguage_Partner', to='data.pperson')),
                ('LanguageLevel', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='PmPersonLanguage_LanguageLevel', to='data.ptlanguagelevel')),
            ],
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('DateOfIssue', models.DateTimeField(null=True)),
                ('CountryOfIssue', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, related_name='PmPassportDetails_CountryOfIssue', to='data.pcountry')),
                ('PassportNationality', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, related_name='PmPassportDetails_PassportNationality', to='data.pcountry')),
                ('Partner', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='PmPassportDetails_Partner', to='data.pperson')),
                ('PassportDetailsType', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, related_name='PmPassportDetails_PassportDetailsType', to='data.ptpassporttype')),
            ],
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('GeneralApplication', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, related_name='PmYearProgramApplication_GeneralApplication', to='data.pmgeneralapplication')),
                ('Position', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, related_name='PmYearProgramApplication_Position', to='data.ptposition')),
            ],
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('Partner', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='PmPersonQualification_Partner', to='data.pperson')),
                ('QualificationArea', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='PmPersonQualification_QualificationArea', to='data.ptqualificationarea')),
                ('QualificationLevel', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='PmPersonQualification_QualificationLevel', to='data.ptqualificationlevel')),
            ],
        ),
        migrations.CreateModel(
            name='PmPersonSkill',
            fields=[
                ...
                ('Comment', models.TextField(max_length=1000, null=True)),
                ('DescriptionLanguage', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, related_name='PmPersonSkill_DescriptionLanguage', to='data.planguage')),
                ('Partner', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='PmPersonSkill_Partner', to='data.pperson')),
                ('SkillCategory', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='PmPersonSkill_SkillCategory', to='data.ptskillcategory')),
                ('SkillLevel', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='PmPersonSkill_SkillLevel', to='data.ptskilllevel')),
            ],
        ),
        migrations.CreateModel(
            name='PPartnerType',
            fields=[
                ...
                ('ValidFrom', models.DateTimeField(null=True)),
                ('ValidUntil', models.DateTimeField(null=True)),
                ('Partner', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='PPartnerType_Partner', to='data.ppartner')),
                ('Type', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='PPartnerType_Type', to='data.ptype')),
            ],
        ),
        migrations.AddField(
            model_name='ptype',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('Country', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, related_name='PUnit_Country', to='data.pcountry')),
                ('OutreachCostCurrency', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, related_name='PUnit_OutreachCostCurrency', to='data.acurrency')),
                ('Partner', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, related_name='PUnit_Partner', to='data.ppartner')),
                ('PrimaryOffice', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='PUnit_PrimaryOffice', to='data.ppartner')),
                ('UnitType', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, related_name='PUnit_UnitType', to='data.uunittype')),
            ],
        ),
        migrations.AddField(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('Partner', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, related_name='PPartnerLedger_Partner', to='data.punit')),
            ],
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('Comment', models.CharField(max_length=512, null=True)),
                ('Country', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, related_name='PPartnerInterest_Country', to='data.pcountry')),
                ('Interest', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, related_name='PPartnerInterest_Interest', to='data.pinterest')),
                ('Partner', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='PPartnerInterest_Partner', to='data.ppartner')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('Comment', models.CharField(max_length=400, null=True)),
                ('Partner', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='PPartnerGiftDestination_Partner', to='data.ppartner')),
                ('PartnerClass', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, related_name='PPartnerGiftDestination_PartnerClass', to='data.ppartnerclasses')),
                ('StaffData', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, related_name='PPartnerGiftDestination_StaffData', to='data.pmstaffdata')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('GeneralApplication', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, related_name='PmShortTermApplication_GeneralApplication', to='data.pmgeneralapplication')),
                ('StCongressLanguage', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, related_name='PmShortTermApplication_StCongressLanguage', to='data.planguage')),
                ('ArrivalPoint', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, related_name='PmShortTermApplication_ArrivalPoint', to='data.ptarrivalpoint')),
                ('DeparturePoint', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, related_name='PmShortTermApplication_DeparturePoint', to='data.ptarrivalpoint')),
                ('OutreachRole', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, related_name='PmShortTermApplication_OutreachRole', to='data.ptcongresscode')),
                ('StCongress', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, related_name='PmShortTermApplication_StCongress', to='data.ptcongresscode')),
                ('StPreCongress', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, related_name='PmShortTermApplication_StPreCongress', to='data.ptcongresscode')),
                ('StSpecialApplicant', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, related_name='PmShortTermApplication_StSpecialApplicant', to='data.ptspecialapplicant')),
                ('TravelTypeFromCong', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, related_name='PmShortTermApplication_TravelTypeFromCong', to='data.pttraveltype')),
                ('TravelTypeToCong', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, related_name='PmShortTermApplication_TravelTypeToCong', to='data.pttraveltype')),
                ('StConfirmedOption', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, related_name='PmShortTermApplication_StConfirmedOption', to='data.punit')),
                ('StCurrentField', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, related_name='PmShortTermApplication_StCurrentField', to='data.punit')),
                ('StFieldCharged', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, related_name='PmShortTermApplication_StFieldCharged', to='data.punit')),
            ],
        ),
        migrations.AddField(
            model_name='pmgeneralapplication',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('FoundationProposal', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='PFoundationProposalDetail_FoundationProposal', to='data.pfoundationproposal')),
                ('MotivationDetail', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, related_name='PFoundationProposalDetail_MotivationDetail', to='data.amotivationdetail')),
                ('AreaPartner', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, related_name='PFoundationProposalDetail_AreaPartner', to='data.punit')),
                ('FieldPartner', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, related_name='PFoundationProposalDetail_FieldPartner', to='data.punit')),
                ('KeyMinistry', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, related_name='PFoundationProposalDetail_KeyMinistry', to='data.punit')),
            ],
        ),
        migrations.CreateModel(
            name='PcExtraCost',
            fields=[
                ...
                ('Attendee', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='PcExtraCost_Attendee', to='data.pcattendee')),
                ('CostType', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, related_name='PcExtraCost_CostType', to='data.pccosttype')),
                ('AuthorisingField', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, related_name='PcExtraCost_AuthorisingField', to='data.punit')),
            ],
        ),
        migrations.AddField(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('Name', models.CharField(max_length=160, null=True)),
                ('Code', models.CharField(max_length=16)),
                ('ContactPartner', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, related_name='PVenue_ContactPartner', to='data.ppartner')),
                ('Currency', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, related_name='PVenue_Currency', to='data.acurrency')),
                ('Partner', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, related_name='PVenue_Partner', to='data.ppartner')),
            ],
        ),
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('Conference', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='PcConferenceVenue_Conference', to='data.pcconference')),
                ('Venue', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='PcConferenceVenue_Venue', to='data.pvenue')),
            ],
        ),
        migrations.AddField(
        ...
        migrations.CreateModel(
            ...
            options={
                'constraints': [models.UniqueConstraint(fields=('TableName', 'Rowid'), name='s_change_event_pk')],
            },
        ),
        migrations.CreateModel(
            name='PLabel',
            fields=[
                ...
                ('Form', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='PLabel_Form', to='data.sform')),
            ],
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('Function1', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='SFunctionRelationship_Function1', to='data.sfunction')),
                ('Function2', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='SFunctionRelationship_Function2', to='data.sfunction')),
            ],
        ),
        migrations.CreateModel(
            name='SGroup',
            ...
            options={
                'constraints': [models.UniqueConstraint(fields=('GroupId', 'UnitKey'), name='s_group_pk')],
            },
        ),
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('CostCentre', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='SGroupCostCentre_CostCentre', to='data.acostcentre')),
                ('Group', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='SGroupCostCentre_Group', to='data.sgroup')),
                ('Ledger', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='SGroupCostCentre_Ledger', to='data.aledger')),
            ],
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('DataLabel', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='SGroupDataLabel_DataLabel', to='data.pdatalabel')),
                ('Group', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='SGroupDataLabel_Group', to='data.sgroup')),
            ],
        ),
        migrations.CreateModel(
            name='SGroupExtract',
            fields=[
                ...
                ('WriteAccess', models.BooleanField(null=True)),
                ('DeleteAccess', models.BooleanField(null=True)),
                ('Extract', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='SGroupExtract_Extract', to='data.mextractmaster')),
                ('Group', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='SGroupExtract_Group', to='data.sgroup')),
            ],
        ),
        migrations.CreateModel(
            name='SGroupFileInfo',
            fields=[
                ...
                ('WriteAccess', models.BooleanField(null=True)),
                ('DeleteAccess', models.BooleanField(null=True)),
                ('FileInfo', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='SGroupFileInfo_FileInfo', to='data.pfileinfo')),
                ('Group', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='SGroupFileInfo_Group', to='data.sgroup')),
            ],
        ),
        migrations.CreateModel(
            name='SGroupFunction',
            fields=[
                ...
                ('Function', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='SGroupFunction_Function', to='data.sfunction')),
                ('Group', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='SGroupFunction_Group', to='data.sgroup')),
            ],
        ),
        migrations.CreateModel(
            name='SGroupGift',
            fields=[
                ...
                ('WriteAccess', models.BooleanField(null=True)),
                ('DeleteAccess', models.BooleanField(null=True)),
                ('Gift', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='SGroupGift_Gift', to='data.agift')),
                ('Group', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='SGroupGift_Group', to='data.sgroup')),
                ('Ledger', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='SGroupGift_Ledger', to='data.aledger')),
            ],
        ),
        migrations.CreateModel(
            name='SGroupLedger',
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('Group', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='SGroupLedger_Group', to='data.sgroup')),
                ('Ledger', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='SGroupLedger_Ledger', to='data.aledger')),
            ],
        ),
        migrations.CreateModel(
            name='SGroupLocation',
            fields=[
                ...
                ('WriteAccess', models.BooleanField(null=True)),
                ('DeleteAccess', models.BooleanField(null=True)),
                ('Group', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='SGroupLocation_Group', to='data.sgroup')),
                ('Location', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='SGroupLocation_Location', to='data.plocation')),
            ],
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('WriteAccess', models.BooleanField(null=True)),
                ('DeleteAccess', models.BooleanField(null=True)),
                ('Group', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='SGroupMotivation_Group', to='data.sgroup')),
                ('Ledger', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='SGroupMotivation_Ledger', to='data.aledger')),
                ('MotivationDetail', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='SGroupMotivation_MotivationDetail', to='data.amotivationdetail')),
            ],
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('WriteAccess', models.BooleanField(null=True)),
                ('DeleteAccess', models.BooleanField(null=True)),
                ('Contact', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='SGroupPartnerContact_Contact', to='data.pcontactlog')),
                ('Group', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='SGroupPartnerContact_Group', to='data.sgroup')),
            ],
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('WriteAccess', models.BooleanField(null=True)),
                ('DeleteAccess', models.BooleanField(null=True)),
                ('Group', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='SGroupPartnerLocation_Group', to='data.sgroup')),
                ('PartnerLocation', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='SGroupPartnerLocation_PartnerLocation', to='data.ppartnerlocation')),
            ],
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('WriteAccess', models.BooleanField(null=True)),
                ('DeleteAccess', models.BooleanField(null=True)),
                ('Group', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='SGroupPartnerReminder_Group', to='data.sgroup')),
                ('PartnerReminder', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='SGroupPartnerReminder_PartnerReminder', to='data.ppartnerreminder')),
            ],
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('WriteAccess', models.BooleanField(null=True)),
                ('DeleteAccess', models.BooleanField(null=True)),
                ('Group', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='SGroupPartnerSet_Group', to='data.sgroup')),
                ('PartnerSet', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='SGroupPartnerSet_PartnerSet', to='data.ppartnerset')),
            ],
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('Group', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='SGroupTableAccessPermission_Group', to='data.sgroup')),
            ],
        ),
        migrations.CreateModel(
            name='SLabel',
            fields=[
                ...
                ('LabelsAcross', models.IntegerField(default=0)),
                ('LabelsDown', models.IntegerField(default=0)),
                ('Form', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='SLabel_Form', to='data.sform')),
            ],
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('Language', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, related_name='SLanguageSpecific_Language', to='data.planguage')),
            ],
        ),
        migrations.CreateModel(
            name='SLogonMessage',
            fields=[
                ...
                ('Language', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, related_name='SLogonMessage_Language', to='data.planguage')),
            ],
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('Group', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='SGroupModuleAccessPermission_Group', to='data.sgroup')),
                ('Module', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='SGroupModuleAccessPermission_Module', to='data.smodule')),
            ],
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('CanDelete', models.BooleanField(default=True, null=True)),
                ('CanInquire', models.BooleanField(default=True, null=True)),
                ('Module', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='SModuleTableAccessPermission_Module', to='data.smodule')),
            ],
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('Default', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='SSystemDefaultsGui_Default', to='data.ssystemdefaults')),
            ],
        ),
        migrations.CreateModel(
            name='SSystemStatus',
            fields=[
                ...
                ('User', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, related_name='SSystemStatus_User', to='data.suser')),
            ],
        ),
        migrations.CreateModel(
            name='SPatchLog',
            fields=[
                ...
                ('User', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, related_name='SPatchLog_User', to='data.suser')),
            ],
        ),
        migrations.CreateModel(
            name='SErrorLog',
            fields=[
                ...
                ('User', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='SErrorLog_User', to='data.suser')),
            ],
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('Partner', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='PRecentPartners_Partner', to='data.ppartner')),
                ('User', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='PRecentPartners_User', to='data.suser')),
            ],
        ),
        migrations.CreateModel(
            name='PPartnerMerge',
            fields=[
                ...
                ('MergeFrom', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, related_name='PPartnerMerge_MergeFrom', to='data.ppartner')),
                ('MergeTo', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, related_name='PPartnerMerge_MergeTo', to='data.ppartner')),
                ('MergedBy', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, related_name='PPartnerMerge_MergedBy', to='data.suser')),
            ],
        ),
        migrations.CreateModel(
            name='PPartnerAction',
            fields=[
                ...
                ('Action', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, related_name='PPartnerAction_Action', to='data.paction')),
                ('PartnerReminder', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='PPartnerAction_PartnerReminder', to='data.ppartnerreminder')),
                ('Group', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, related_name='PPartnerAction_Group', to='data.sgroup')),
                ('UserThatPerformedAction', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, related_name='PPartnerAction_UserThatPerformedAction', to='data.suser')),
                ('UserToPerformAction', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, related_name='PPartnerAction_UserToPerformAction', to='data.suser')),
            ],
        ),
        migrations.AddField(
            model_name='pmgeneralapplication',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('Options', models.CharField(max_length=64, null=True)),
                ('AddressLayout', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, related_name='PForm_AddressLayout', to='data.paddresslayoutcode')),
                ('FormLanguage', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='PForm_FormLanguage', to='data.planguage')),
                ('TemplateUploadedByUser', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, related_name='PForm_TemplateUploadedByUser', to='data.suser')),
            ],
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('Partner', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='PCustomisedGreeting_Partner', to='data.ppartner')),
                ('User', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='PCustomisedGreeting_User', to='data.suser')),
            ],
        ),
        migrations.AddField(
            model_name='mextractmaster',
        ...
        migrations.CreateModel(
            ...
            options={
                'constraints': [models.UniqueConstraint(fields=('UserId', 'ActivityDate', 'ActivityTime', 'ActivityType'), name='s_user_account_activity_pk')],
            },
        ),
        migrations.CreateModel(
            name='SUserDefaults',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('Volume', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, related_name='SDefaultFileVolume_Volume', to='data.svolume')),
                ('Group', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='SDefaultFileVolume_Group', to='data.svolumepartnergroup')),
            ],
        ),
        migrations.CreateModel(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('Group', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='SJobGroup_Group', to='data.sgroup')),
                ('Job', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='SJobGroup_Job', to='data.umjob')),
            ],
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('Partner', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='PmJobAssignment_Partner', to='data.ppartner')),
                ('AssignmentType', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, related_name='PmJobAssignment_AssignmentType', to='data.ptassignmenttype')),
                ('Job', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='PmJobAssignment_Job', to='data.umjob')),
            ],
        ),
        migrations.CreateModel(
            name='UmJobLanguage',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('ArCategory', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='AArDefaultDiscount_ArCategory', to='data.aarcategory')),
                ('ArDiscount', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='AArDefaultDiscount_ArDiscount', to='data.aardiscount')),
            ],
            options={
                'constraints': [models.UniqueConstraint(fields=('ArCategory', 'ArDiscount'), name='ar_default_discount_pk')],
            },
        ),
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('ArCategory', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='AArDiscountPerCategory_ArCategory', to='data.aarcategory')),
                ('ArDiscount', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='AArDiscountPerCategory_ArDiscount', to='data.aardiscount')),
            ],
            options={
                'constraints': [models.UniqueConstraint(fields=('ArCategory', 'ArDiscount'), name='ar_discount_per_category_pk')],
            },
        ),
        migrations.CreateModel(
            name='ABudgetPeriod',
            fields=[
                ...
                ('BudgetBase', models.DecimalField(decimal_places=10, default=0, max_digits=24, null=True)),
                ('BudgetSequence', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='ABudgetPeriod_BudgetSequence', to='data.abudget')),
            ],
            options={
                'constraints': [models.UniqueConstraint(fields=('BudgetSequence', 'PeriodNumber'), name='a_budget_period_pk')],
            },
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('RateOfExchange', models.DecimalField(decimal_places=10, default=0, max_digits=24)),
                ('TimeEffectiveFrom', models.IntegerField(default=0)),
                ('FromCurrency', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='ACorporateExchangeRate_FromCurrency', to='data.acurrency')),
                ('ToCurrency', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='ACorporateExchangeRate_ToCurrency', to='data.acurrency')),
            ],
            options={
                'constraints': [models.UniqueConstraint(fields=('FromCurrency', 'ToCurrency', 'DateEffectiveFrom'), name='a_corporate_exchange_rate_pk')],
            },
        ),
